            ...
            <div className='border-2 border-emerald-600 p-20'>
                <form onSubmit={(e) => {
                    ...
                    <input
                        ...
                        required className='outline-none bg-transparent border-2 border-emerald-600 text-xl py-3 px-5 rounded-full mt-3 placeholder:text-grey-400' type="password" placeholder='Enter password' />
